...
@Component
@AllArgsConstructor
public class AnswerNoHandler implements InputMessageHandler {
    ...
    public BotState getHandlerName() {
        return BotState.CANCEL;
    }

    private SendMessage processUsersInput(Message inputMsg) {
        return messagesService.getReplyMessage(inputMsg.getChatId(), "reply.cancel");
    }
}
